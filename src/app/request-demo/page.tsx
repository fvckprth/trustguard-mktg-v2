...
export default function RequestDemoPage() {
  ...
  return (
    <section className="pt-32 md:pt-52 px-6 md:px-10 pb-20 md:pb-40">
      <div className="max-w-[1280px] mx-auto flex flex-col gap-10 md:gap-16">
        <div className="flex flex-col gap-2 text-2xl md:text-[2rem] tracking-tight">
          ...
          <p className="leading-snug text-muted max-w-[40rem]">
            See how TrustGuard helps your team assess vendors faster, surface
            real risk, and stay audit-ready.
          </p>
        </div>

        <div className="bg-surface rounded p-6 md:p-10">
          <form onSubmit={handleSubmit} className="flex flex-col gap-10">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="flex flex-col gap-2">
                <label
                  htmlFor="fullName"
                  className="text-base tracking-tight leading-tight"
                >
                  Full name
                </label>
                <input
                  ...
                  autoComplete="name"
                  required
                  className="h-12 rounded border border-border bg-background px-4 text-base leading-tight placeholder:text-muted focus:outline-none focus:ring-2 focus:ring-foreground/20"
              ...
              <div className="flex flex-col gap-2 md:col-span-2">
                ...
                <textarea
                  ...
                  name="message"
                  rows={6}
                  className="rounded border border-border bg-background px-4 py-3 text-base leading-snug placeholder:text-muted focus:outline-none focus:ring-2 focus:ring-foreground/20 resize-y"
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              <p className="text-base leading-snug text-muted max-w-[36rem]">
