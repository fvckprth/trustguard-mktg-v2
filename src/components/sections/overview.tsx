...
const ILLUSTRATIONS: ComponentType[] = [
  EvidenceIngestIllustration,
  AIAnalyticsIllustration,
  FindingsSummaryIllustration,
];
...
export async function Overview() {
  ...
  const cards = [0, 1, 2].map((i) => ({
    title: c(`home.overview.${i}.title`),
    subtitle: c(`home.overview.${i}.subtitle`),
