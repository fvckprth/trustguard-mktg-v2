  ...
  return (
    <section className="px-6 md:px-10">
      <div className="max-w-[1280px] mx-auto">
        <div className="bg-surface rounded-md flex flex-col md:flex-row items-start justify-between p-8 md:p-40 gap-10 md:gap-16">
          <p className="text-sm md:text-xl leading-snug text-muted tracking-tight shrink-0">
            Mission
          </p>

          <div className="flex flex-col gap-16">
            <div className="flex flex-col gap-10 text-lg md:text-[2rem] tracking-tight leading-snug max-w-full md:max-w-[540px]">
              <p>
